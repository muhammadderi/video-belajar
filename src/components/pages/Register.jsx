...
import InputCountry from "../atoms/InputCountry";
import Button from "../atoms/Button";
import { createUserVideos } from "../../services/videosApi";
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (users.password !== users.confirmPassword) {
      toast.warning("Katasandi tidak cocok!");
    } else if (users.phone.length < 8) {
      toast.warning("Nomer telepon harus lebih dari 7");
    } else {
      try {
        await createUserVideos(users);
